...
/**
 * Servlet implementation class WithdrawCashS
 */
public class WithdrawCashS extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WithdrawCashS() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isSuccess = employeeService.withdraw(empId, accNo, amt);
		...
		request.setAttribute("withdrawSuccess", msgSuccess);
		request.setAttribute("withdrawError", msgError);
