...
<body>
    ...
    <form method=get action="transactionS">
        ...
        <input type="number" name="accNo" id="accNo" value="<%= request.getAttribute("accNo") != null ? request.getAttribute("accNo").toString() : "" %>" required><br><br>
        <label for="amount">Amount:</label>
        <input type="number" id="amount" name="amount" value="<%= request.getAttribute("amount") != null ? request.getAttribute("amount").toString() : "" %>" required><br><br>
