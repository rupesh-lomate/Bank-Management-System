...
<head>
    ...
    <style>
        ...
        .withdraw-box form input[type="number"] {
            width: calc(100% - 20px);
            padding: 10px;
            margin-bottom: 15px;
        ...
        .withdraw-box form button:hover {
            background-color: #0e5a99;
        }
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="withdraw-box" id="withdrawBox">
                ...
                <form action="withdrawCashS" method="post">
                    <input type="number" name="accNo" placeholder="Account Number" required>
                    <input type="number" name="amount" placeholder="Amount" required>
                    <button type="submit">Withdraw</button>
                </form>
                <% if (request.getAttribute("withdrawSuccess") != null) { %>
                    <p class="message success"><b><%= request.getAttribute("withdrawSuccess") %></b></p>
                <% } else if (request.getAttribute("withdrawError") != null) { %>
                    <p class="message error"><b><%= request.getAttribute("withdrawError") %></b></p>
                <% } %>
            </div>
        </div>
    </div>
